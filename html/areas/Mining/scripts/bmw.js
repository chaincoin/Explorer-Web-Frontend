...
var setupBmw = function(scope){

	// var V_INIT = [
	//   op.u(0x80818283, 0x84858687), op.u(0x88898A8B, 0x8C8D8E8F),
	//   op.u(0x90919293, 0x94959697), op.u(0x98999A9B, 0x9C9D9E9F),
	//   op.u(0xA0A1A2A3, 0xA4A5A6A7), op.u(0xA8A9AAAB, 0xACADAEAF),
	//   op.u(0xB0B1B2B3, 0xB4B5B6B7), op.u(0xB8B9BABB, 0xBCBDBEBF),
	//   op.u(0xC0C1C2C3, 0xC4C5C6C7), op.u(0xC8C9CACB, 0xCCCDCECF),
	//   op.u(0xD0D1D2D3, 0xD4D5D6D7), op.u(0xD8D9DADB, 0xDCDDDEDF),
	//   op.u(0xE0E1E2E3, 0xE4E5E6E7), op.u(0xE8E9EAEB, 0xECEDEEEF),
	//   op.u(0xF0F1F2F3, 0xF4F5F6F7), op.u(0xF8F9FAFB, 0xFCFDFEFF)
	// ];
	...
	// var final = [
	//   op.u(0xaaaaaaaa, 0xaaaaaaa0), op.u(0xaaaaaaaa, 0xaaaaaaa1),
	//   op.u(0xaaaaaaaa, 0xaaaaaaa2), op.u(0xaaaaaaaa, 0xaaaaaaa3),
	//   op.u(0xaaaaaaaa, 0xaaaaaaa4), op.u(0xaaaaaaaa, 0xaaaaaaa5),
	//   op.u(0xaaaaaaaa, 0xaaaaaaa6), op.u(0xaaaaaaaa, 0xaaaaaaa7),
	//   op.u(0xaaaaaaaa, 0xaaaaaaa8), op.u(0xaaaaaaaa, 0xaaaaaaa9),
	//   op.u(0xaaaaaaaa, 0xaaaaaaaa), op.u(0xaaaaaaaa, 0xaaaaaaab),
	//   op.u(0xaaaaaaaa, 0xaaaaaaac), op.u(0xaaaaaaaa, 0xaaaaaaad),
	//   op.u(0xaaaaaaaa, 0xaaaaaaae), op.u(0xaaaaaaaa, 0xaaaaaaaf)
	// ];
	...
	var fold = function(int64Buffer, state) {
		...
		out[8] = out[4].rotateLeft(9).add(op.xor64(xh, qt[24], int64Buffer[8]))
			.add(op.xor64(xl.shiftLeft(8), qt[23], qt[8]));
		out[9] = out[5].rotateLeft(10).add(op.xor64(xh, qt[25], int64Buffer[9]))
			.add(op.xor64(xl.shiftRight(6), qt[16], qt[9]));
		out[10] = out[6].rotateLeft(11).add(op.xor64(xh, qt[26], int64Buffer[10]))
			.add(op.xor64(xl.shiftLeft(6), qt[17], qt[10]));
		out[11] = out[7].rotateLeft(12).add(op.xor64(xh, qt[27], int64Buffer[11]))
			.add(op.xor64(xl.shiftLeft(4), qt[18], qt[11]));
		out[12] = out[0].rotateLeft(13).add(op.xor64(xh, qt[28], int64Buffer[12]))
			.add(op.xor64(xl.shiftRight(3), qt[19], qt[12]));
		out[13] = out[1].rotateLeft(14).add(op.xor64(xh, qt[29], int64Buffer[13]))
			.add(op.xor64(xl.shiftRight(4), qt[20], qt[13]));
		out[14] = out[2].rotateLeft(15).add(op.xor64(xh, qt[30], int64Buffer[14]))
			.add(op.xor64(xl.shiftRight(7), qt[21], qt[14]));
		out[15] = out[3].rotateLeft(16).add(op.xor64(xh, qt[31], int64Buffer[15]))
			.add(op.xor64(xl.shiftRight(2), qt[22], qt[15]));
		return out;
	};
	...
	var bmw = function(ctx, data) {
		...
		ctx.ptr = ptr;
		if (h1 !== ctx.state) op.bufferInsert(ctx.state, 0, h1, ctx.state.length);
	};
	...
	scope.bmw = function(input, format, output) {
		var msg;
		if (format === 1) {
			msg = input;
		}
