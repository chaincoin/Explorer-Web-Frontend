...
h.int8ArrayToHexString = function toString(array) {
    var string = '';
...
h.int32ArrayToHexString = function toString(array) {
    var string = '';
...
/*
h.bytes2Int16Buffer = function(b) {
	var len = b.length;
...
h.bytes2Int32Buffer = function(b) {
    if (!b) return [];
...
/*
h.bytes2Int32BufferLeAligned = function(b) {
	var len = b.length;
	if (!len) return [];
...
*/
h.bytes2Int64Buffer = function(b) {
    if (!b) return [];
...
h.bytes2Int64BufferLeAligned = function(b) {
    if (!b) return [];
    var len = b.length ? ((( b.length - 1) >>> 3) + 1) : 0;
    var buffer = new Array(len);
    var j = 0;
...
h.bufferEncode64leAligned = function(buffer, offset, uint64) {
...
h.bufferEncode64 = function(buffer, offset, uint64) {
...
h.int32Buffer2Bytes = function(b) {
...
/*
h.int64Buffer2Bytes = function(b) {
	var buffer = new Array(b.length);
	var i = 0;
	while (i < b.length) {
