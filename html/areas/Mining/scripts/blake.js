...
var setupBlake = function(scope){
	...
	// var CB = [
	//   op.u(0x243f6a88, 0x85a308d3),
	//   op.u(0x13198a2e, 0x03707344),
	//   op.u(0xa4093822, 0x299f31d0),
	//   op.u(0x082efa98, 0xec4e6c89),
	//   op.u(0x452821e6, 0x38d01377),
	//   op.u(0xbe5466cf, 0x34e90c6c),
	//   op.u(0xc0ac29b7, 0xc97c50dd),
	//   op.u(0x3f84d5b5, 0xb5470917),
	//   op.u(0x9216d5d9, 0x8979fb1b),
	//   op.u(0xd1310ba6, 0x98dfb5ac),
	//   op.u(0x2ffd72db, 0xd01adfb7),
	//   op.u(0xb8e1afed, 0x6a267e96),
	//   op.u(0xba7c9045, 0xf12c7f99),
	//   op.u(0x24a19947, 0xb3916cf7),
	//   op.u(0x0801f2e2, 0x858efc16),
	//   op.u(0x636920d8, 0x71574e69)
	// ];
	...
	scope.blake = function(input, format, output) {
		var msg;
		if (format === 1) {
			msg = input;
		}
