...
var setupJh = function(scope){
	...
	var jhClose = function(ctx) {
		...
		l[3] = 0;
		var lBytes = h.int32Buffer2Bytes(op.swap32Array(l));
	...
	scope.jh = function(input, format, output) {
		var msg;
		if (format === 1) {
			msg = input;
		}
