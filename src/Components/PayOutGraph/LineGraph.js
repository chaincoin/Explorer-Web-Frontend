...
export default props =>{
    ...
    const graphData = React.useMemo(() =>({
        datasets: addressStates.map((stats,i) => ({
            label: names == null ? addresses[i] : names[i],
            backgroundColor: payOutsLineColours[i % payOutsLineColours.length],
            borderColor: payOutsLineColours[i % payOutsLineColours.length],
            fill: false,
